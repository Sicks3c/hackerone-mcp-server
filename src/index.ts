...
server.tool(
  "update_report_draft",
  "Update the description of a HAI report draft (report intent). Only the description can be changed — the title is generated by HAI. The draft must not be submitted yet. Updating re-triggers HAI's analysis jobs; poll with get_report_draft until state is 'ready_to_submit'.",
  {
